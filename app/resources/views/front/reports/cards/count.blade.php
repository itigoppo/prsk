                    ...
                    <table class="table table-sm table-striped table-hover table-sort">
                        ...
                        @foreach($virtualSingers as $member)
                            <tr>
                                ...
                                <td class="text-end">{{ $member->getAttribute('report_total_limited_count') }}</td>
                                ...
                                <td class="text-end">{{ $member->getAttribute('report_another_cut_count') }}</td>
                                <td class="text-end">{{ $member->getAttribute('report_avatar_accessory_count') }}</td>
